...
import { hasDb } from "@/lib/db/index";
import { brl, area, tipoLabel, linkWhatsApp, portalBadge } from "@/lib/format";
import ScoreBadgeReativo from "@/components/ScoreBadgeReativo";
import TierRailReativo from "@/components/TierRailReativo";
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950">
      <div className="mx-auto w-full max-w-5xl px-4 py-8">
        ...
        {/* Cabeçalho do imóvel */}
        <div className="relative mb-6 rounded-xl border border-zinc-200 bg-white p-4 pl-6 dark:border-zinc-800 dark:bg-zinc-900">
          <TierRailReativo
        ...
        <div className="mb-4 rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
          {lead.temContatoDireto ? (
            ...
            <div>
              ...
              <p className="mt-0.5 font-semibold text-zinc-900 dark:text-zinc-100">
                {lead.anunciantes[0]
                  ? `Vinculado a ${lead.anunciantes[0]}`
                  : "Vinculado a uma imobiliária"}
              </p>
              <p className="mt-1 text-xs text-zinc-400 dark:text-zinc-500">
                Contato direto com o dono disponível quando há anúncio particular.
              </p>
            </div>
          )}
        </div>
